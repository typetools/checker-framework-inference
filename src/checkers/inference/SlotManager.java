...
public interface SlotManager {
     ...
     * Then getSlot( A ) will return S (or an equivalent Slot in case of Constants ).
     *
    ...
    /**
     * Return the VariableSlot in the primary annotation location of annotated type mirror. If there
     * is no VariableSlot this method throws an exception
     *
