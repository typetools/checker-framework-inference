 ...
 *
 * <p>Each slot is attached to a code location that can hold an annotation OR has an intrinsic
 * meaning within type-systems. E.g: an int literal is always NonNull but can't hold an annotation,
