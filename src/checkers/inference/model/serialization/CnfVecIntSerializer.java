    ...
    public VecInt[] serialize(ExistentialConstraint constraint) {
        ...
        if (existentialId == null) {
            ...
            this.existentialToPotentialVar.put(
                    new Integer(existentialId),
                    new Integer(constraint.getPotentialVariable().getId()));
        }

        /**
         * if we have an existential constraint of the form:
         *
         * <p>if (a exists) { a <: b } else { c <: b }
         *
         * <p>Let E be a new variable that implies that a exists.
         *
         * <p>The above existential constraint becomes: (E => a <: b) && (!E => c <: b)
         *
         * <p>Recall: x <: y <=> !x | y
         *
         * <p>Then the existential constraint becomes: (E => a | !b) && (!E => c | !b)
         *
