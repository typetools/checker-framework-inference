    ...
    private static void copyAnnotationsImpl(final AnnotatedTypeMirror from, final AnnotatedTypeMirror to,
        ...
        if (fromKind == PACKAGE) {
            ...
            if (fromSuperTypes.size() != toSuperTypes.size()) {
                throw new CheckerFrameworkBug("unequal super types when copying INTERSECTION type! from: " + fromIntersec + " to: " + toIntersec);
            }
            ...
            throw new CheckerFrameworkBug("InferenceUtils.copyAnnotationsImpl: unhandled getKind results: " + from +
