...
public class LogiQLFormatTranslator implements FormatTranslator<String, String, String> {
    ...
    public String serialize(SubtypeConstraint constraint) {
        return new SubtypeVariableCombos(emptyString, contradictoryString, lattice).accept(constraint.getSubtype(),
    ...
    protected class SubtypeVariableCombos extends VariableCombos<SubtypeConstraint,String> {   
        ...
        public SubtypeVariableCombos(String emptyValue, String contradictoryValue, Lattice lattice) {
    ...
    public String serialize(EqualityConstraint constraint) {
        return new EqualityVariableCombos(emptyString, contradictoryString, lattice).accept(constraint.getFirst(),
                constraint.getSecond(), constraint);
    }

    protected class EqualityVariableCombos extends VariableCombos<EqualityConstraint, String> {

        public EqualityVariableCombos(String emptyValue, String contradictoryValue, Lattice lattice) {
            super(emptyValue, contradictoryValue, lattice);
        }
    ...
    public String serialize(InequalityConstraint constraint) {
        return new InequalityVariableCombos(emptyString, contradictoryString, lattice).accept(constraint.getFirst(),
                constraint.getSecond(), constraint);
    }

    protected class InequalityVariableCombos extends VariableCombos<InequalityConstraint, String> {

        public InequalityVariableCombos(String emptyValue, String contradictoryValue, Lattice lattice) {
            super(emptyValue, contradictoryValue, lattice);
        }
    ...
    public String serialize(ComparableConstraint constraint) {
        return new ComparableVariableCombos(emptyString, contradictoryString, lattice).accept(constraint.getFirst(),
                constraint.getSecond(), constraint);
    }

    protected class ComparableVariableCombos extends VariableCombos<ComparableConstraint, String> {

        public ComparableVariableCombos(String emptyValue, String contradictoryValue, Lattice lattice) {
            super(emptyValue, contradictoryValue, lattice);
        }
