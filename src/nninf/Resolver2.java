...
public class Resolver2 {
    ...
    public Resolver2(ProcessingEnvironment env) {
        ...
        try {
            ...
            throw new CheckerFrameworkBug("Compiler 'Resolve' class doesn't contain required 'findXXX' method", e);
    ...
    private Symbol wrapInvocation(Method method, Object... args) {
        try {
            ...
            throw new CheckerFrameworkBug("Resolver.wrapInvocation: unexpected Reflection error", e);
