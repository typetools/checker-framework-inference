 ...
 *
 * <p>TODO: This class is only supposed to be used temporarily until a good solution for the
 * MapGetHeuristic is found.
 */
public class Resolver2 {
    ...
    public Resolver2(ProcessingEnvironment env) {
        ...
        try {
            ...
            fmt =
                    Resolve.class.getDeclaredMethod(
                            "findMemberType", Env.class, Type.class, Name.class, TypeSymbol.class);
     ...
     *
     * <p>This method may only operate on variable references, e.g. local variables, parameters,
     * fields.
     *
     * <p>The reference string may be either an single Java identifier (e.g. "field") or
     * dot-separated identifiers (e.g. "Collections.EMPTY_LIST").
     *
